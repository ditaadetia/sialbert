...
export default function LoginPage({ navigation, route }) {
  const alat = {
    nama: "Nama ecek ecek",
    harga_sewa_perhari: 5000000,
    harga_sewa_perjam: 500000,
    // foto: excavator,
  };
  let data = [
    {
  ...
  return (
    <View style={{ backgroundColor: "#fff" }}>
      ...
      <View style={{ height: 100, width: "100%" }}>
        <Image source={excavator} style={styles.equipmentImage} />
      </View>
      ...
      <View
        style={{ borderBotomColor: "yellow", borderBottomWidth: 2 }}
        opacity={0.1}
      />
      <View>
        <Text
