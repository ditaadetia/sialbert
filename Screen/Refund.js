...
export default function MenuUtama({navigation}) {
  ...
  useEffect(async() => {
    setIsLoading(true);
    fetch('http://74d6-2001-448a-6060-f025-4436-aa10-3308-85b4.ngrok.io/api/refunds')
  ...
  useEffect(async() => {
    setIsLoading(true);
    fetch('http://74d6-2001-448a-6060-f025-4436-aa10-3308-85b4.ngrok.io/api/detail-refunds')
      .then((response) => response.json())
      .then((hasil) => {
        setEquipments(hasil);
        setCari(hasil);
